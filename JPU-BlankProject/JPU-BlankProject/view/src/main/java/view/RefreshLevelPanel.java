 ...
 * @author Lemovou Ivan
 */
public class RefreshLevelPanel implements Runnable {
    ...
    private static final Logger LOGGER = Logger.getLogger(RefreshLevelPanel.class.getName());

    public RefreshLevelPanel(int pause, LevelPanel panel) {
        this.pause = pause;
        this.panel = panel;
    }
